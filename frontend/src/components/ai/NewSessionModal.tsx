...
import { StartChatSessionRequest } from '@/types/ai.types';
...
const PRESET_AGENTS = [
    {
        ...
        systemPrompt: 'You are an expert database schema designer. Help users create well-structured, normalized database schemas.',
    },
    {
        name: 'Query Optimizer',
        description: 'Suggests performance improvements and indexes',
        systemPrompt: 'You are a database performance expert. Analyze schemas and suggest optimization strategies, indexes, and query patterns.',
    },
    {
        name: 'Migration Assistant',
        description: 'Helps plan and execute schema migrations',
        systemPrompt: 'You are a database migration expert. Help users plan safe schema migrations with minimal downtime.',
    },
    {
        name: 'Documentation Writer',
        description: 'Generates documentation for database schemas',
        systemPrompt: 'You are a technical writer specializing in database documentation. Create clear, comprehensive documentation.',
    },
];

export const NewSessionModal: React.FC<NewSessionModalProps> = ({ isOpen, onClose, diagramId }) => {
    ...
    const selectedPresetAgent = PRESET_AGENTS.find((a) => a.name === selectedAgent);
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[500px]">
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            ...
                            <p className="font-medium text-sm">Preset Agent</p>
                            <p className="text-xs text-gray-500 mt-1">Choose from expert agents</p>
                        </button>
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 mt-1">Create your own agent</p>
                        </button>
                    </div>
                    ...
                    {agentType === 'custom' && (
                        <div className="space-y-3">
                            ...
                            <p className="text-xs text-gray-500">
                                Define the behavior and expertise of your custom AI agent
                            </p>
                        </div>
                    )}
                    ...
                    <div className="p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <p className="text-xs text-blue-700 dark:text-blue-300">
                            💡 The AI assistant will automatically include your current diagram context in every conversation
                        </p>
                    </div>
                </div>
                ...
                <DialogFooter>
                    ...
                    <Button
                        onClick={handleStart}
                        disabled={agentType === 'custom' && !customSystemPrompt.trim()}
                    >
                        Start Chat
                    </Button>
                </DialogFooter>
