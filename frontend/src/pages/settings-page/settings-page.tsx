...
import { aiConfigApi, type AIProvider, type AIConfig, type AIConfigResponse } from '@/services/api';
import { Loader2, Save, Trash2, Eye, EyeOff, Check, AlertCircle, ArrowLeft } from 'lucide-react';
...
export const SettingsPage: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        const effectiveApiKey = selectedProvider === 'mistral' ? mistralApiKey : apiKey;
    ...
    const defaultModels: Record<string, string[]> = {
        ...
        gemini: ['gemini-3-flash-preview', 'gemini-1.5-flash', 'gemini-1.5-pro', 'gemini-1.5-flash-8b'],
    ...
    const mistralApiKey = '82be75bab472c188118d3857ca2c07fc11365c4d2c23284f9fbf75e2cd79f717';
            ...
            <Card className="mb-6">
                <CardHeader>
                    ...
                    <CardDescription>
                        ...
                        You'll need an API key from OpenAI, Google Gemini, Anthropic Claude, or use our hosted Mistral AI.
                    </CardDescription>
                </CardHeader>
                        ...
                        <>
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        <Input
                                            ...
                                            value={isMistralProvider ? mistralApiKey : apiKey}
                                ...
                                <p className="text-xs text-muted-foreground">
                                    ...
                                    {selectedProvider === 'claude' && 'Get your API key from https://console.anthropic.com/settings/keys'}
                                    {selectedProvider === 'mistral' && 'Mistral AI is hosted on our servers - use the provided API key'}
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {(selectedProviderData?.models || defaultModels[selectedProvider] || []).map((model) => (
                            ...
                            <div className="flex gap-2 pt-4">
                                <Button
                                    onClick={handleSave}
                                    disabled={saving || !selectedProvider || !selectedModel || (!isMistralProvider && !apiKey)}
                                >
                                    {saving ? (
                                        <>
            ...
            {currentConfig?.configured && (
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Your AI assistant usage information</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div>
                                ...
                                <p className="text-2xl font-bold">
                                    {(currentConfig.usageStats?.totalTokens || 0).toLocaleString()}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-muted-foreground">Total Requests</p>
                                <p className="text-2xl font-bold">
                                    {currentConfig.usageStats?.totalRequests || 0}
                                </p>
                            </div>
                            <div>
                                ...
                                <p className="text-2xl font-bold">
                                    {currentConfig.usageStats?.lastUsed
                                        ? new Date(currentConfig.usageStats.lastUsed).toLocaleDateString()
                                        : 'Never'}
                                </p>
                            </div>
                        </div>
